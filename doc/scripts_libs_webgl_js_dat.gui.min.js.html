...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: scripts/libs/webgl/js/dat.gui.min.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: scripts/libs/webgl/js/dat.gui.min.js</h1>
...
dat.GUI = dat.gui.GUI = function(e, a, c, d, f, b, n, h, j, m, l, o, y, g, i) {
    ...
    k.CLASS_DRAG = "drag";
    k.DEFAULT_WIDTH = 245;
    k.TEXT_CLOSED = "Close Menu";
    k.TEXT_OPEN = "Open Menu";
